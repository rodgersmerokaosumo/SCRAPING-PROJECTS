...
#%%
##create database
mercado_db_dominica = mysql.connector.connect(
  host="localhost",
  user="root",
  password="4156",
...
mycursor = mercado_db_dominica.cursor()

# Credentials to database connection
hostname="localhost"
dbname="mercado_db_dominica"
uname="root"
pwd="4156"
...
mycursor.execute("DROP DATABASE  IF EXISTS mercado_db_dominica")
mycursor.execute("CREATE DATABASE  IF NOT EXISTS mercado_db_dominica")
...
#%%
link = "https://listado.mercadolibre.com.do/tv#D[A:tv]"
is_scraped = 0
def get_links(link):
