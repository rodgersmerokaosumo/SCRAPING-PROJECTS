...
#%%
##create database
mercado_db_elsavador = mysql.connector.connect(
  host="localhost",
  user="root",
  password="4156",
...
mycursor = mercado_db_elsavador.cursor()

# Credentials to database connection
hostname="localhost"
dbname="mercado_db_elsavador"
uname="root"
pwd="4156"
...
#%%
mycursor.execute("use mercado_db_elsavador")
...
#%%
df_links = pd.read_sql('SELECT * FROM tv_links WHERE is_scraped = 0', con=mercado_db_elsavador)
...
#%%
df = pd.read_sql('SELECT * FROM data_table', con=mercado_db_elsavador)
none_links = []
