...
mycursor.execute("DROP DATABASE  IF EXISTS mercado_db_uruguay")
mycursor.execute("CREATE DATABASE  IF NOT EXISTS mercado_db_uruguay")
...
#%%
link = "https://listado.mercadolibre.com.uy/tv#D[A:TV]"
is_scraped = 0
