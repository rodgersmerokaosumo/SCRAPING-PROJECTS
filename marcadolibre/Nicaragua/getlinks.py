...
#%%
##create database
mercado_db_nicaragua = mysql.connector.connect(
  host="localhost",
  user="root",
  password="4156",
...
mycursor = mercado_db_nicaragua.cursor()

# Credentials to database connection
hostname="localhost"
dbname="mercado_db_nicaragua"
uname="root"
pwd="4156"
...
mycursor.execute("DROP DATABASE  IF EXISTS mercado_db_nicaragua")
mycursor.execute("CREATE DATABASE  IF NOT EXISTS mercado_db_nicaragua")
mycursor.execute("use mercado_db_nicaragua")
mycursor.execute("""CREATE TABLE IF NOT EXISTS tv_links(link varchar(200) UNIQUE, is_scraped TINYINT)""")

#%%
link = "https://listado.mercadolibre.com.ni/tv#D[A:tv]"
is_scraped = 0
