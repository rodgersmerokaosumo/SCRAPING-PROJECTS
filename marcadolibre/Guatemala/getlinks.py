...
mycursor.execute("DROP DATABASE  IF EXISTS mercado_db_guatemala")
mycursor.execute("CREATE DATABASE  IF NOT EXISTS mercado_db_guatemala")
...
#%%
link = "https://listado.mercadolibre.com.gt/tv#D[A:tv]"
is_scraped = 0
