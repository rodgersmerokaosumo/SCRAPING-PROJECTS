...
mycursor.execute("DROP DATABASE  IF EXISTS mercado_db_brazil")
mycursor.execute("CREATE DATABASE  IF NOT EXISTS mercado_db_brazil")
...
#%%
link = "https://lista.mercadolivre.com.br/tv#D[A:Tv]"
is_scraped = 0
# %%
def get_links(link):
