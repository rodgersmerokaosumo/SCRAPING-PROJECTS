...
#%%
##create database
mercado_db_honduras = mysql.connector.connect(
  host="localhost",
  user="root",
  password="4156",
...
mycursor = mercado_db_honduras.cursor()

# Credentials to database connection
hostname="localhost"
dbname="mercado_db_honduras"
uname="root"
pwd="4156"
...
#%%
mycursor.execute("use mercado_db_honduras")
...
#%%
df_links = pd.read_sql('SELECT * FROM tv_links WHERE is_scraped = 0', con=mercado_db_honduras)
...
for link in links:
    ...
    mercado_db_honduras.commit()


#%%
df = pd.read_sql('SELECT * FROM data_table', con=mercado_db_honduras)
none_links = []
