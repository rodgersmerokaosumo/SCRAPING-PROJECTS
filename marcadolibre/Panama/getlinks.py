...
#%%
##create database
mercado_db_panama = mysql.connector.connect(
  host="localhost",
  user="root",
  password="4156",
...
mycursor = mercado_db_panama.cursor()

# Credentials to database connection
hostname="localhost"
dbname="mercado_db_panama"
uname="root"
pwd="4156"
...
mycursor.execute("DROP DATABASE  IF EXISTS mercado_db_panama")
mycursor.execute("CREATE DATABASE  IF NOT EXISTS mercado_db_panama")
mycursor.execute("use mercado_db_panama")
mycursor.execute("""CREATE TABLE IF NOT EXISTS tv_links(link varchar(200) UNIQUE, is_scraped TINYINT)""")

#%%
link = "https://listado.mercadolibre.com.pa/tv#D[A:TV]"
is_scraped = 0
