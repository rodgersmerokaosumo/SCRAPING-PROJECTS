...
mycursor.execute("DROP DATABASE  IF EXISTS mercado_db_mexico")
mycursor.execute("CREATE DATABASE  IF NOT EXISTS mercado_db_mexico")
...
#%%
link = "https://listado.mercadolibre.com.mx/tv#D[A:TV]"
is_scraped = 0
